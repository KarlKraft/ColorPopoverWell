...
public class ColorPopoverWell: NSColorWell {
  ...
  var wheelRect: NSRect {
    NSMakeRect(0.6969 * bounds.size.width, 0, 0.3030 * bounds.size.width, bounds.size.height)
  }

  var colorRect: NSRect {
    NSMakeRect(0, 0, 0.6969 * bounds.size.width, bounds.size.height)
  }
  ...
  lazy var popover: NSPopover = {
    ...
    popover.contentViewController = NSViewController(nibName: "ColorPopoverWell", bundle: .module)
  ...
  override public func mouseDown(with startEvent: NSEvent) {
